...
$classes = Flux::classes()
    ->add('flex whitespace-nowrap flex-1 py-2 justify-center items-center gap-2')
    ...
    ->add('data-checked:bg-mine-200 data-checked:text-white! dark:data-checked:bg-white/20')
...
$iconClasses = Flux::classes('text-zinc-500 dark:text-zinc-400 [ui-radio[data-checked]_&]:text-white dark:[ui-radio[data-checked]_&]:text-white')
