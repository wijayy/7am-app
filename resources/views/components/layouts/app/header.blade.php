...
<body class="bg-[#E8E1D7] min-h-screen static font-poppins">
    <nav
        class="fixed top-4 left-1/2 -translate-x-1/2 w-[98%] z-50 bg-white shadow-md rounded-full px-6 py-6 flex items-center justify-between">
        ...
        <ul class="flex space-x-4 mr-8">
            ...
            @auth
                ...
                <li><a href="{{ route('cart') }}" current="{{ request()->routeIs('cart') }}">Cart</a></li>
                <li><a href="{{ route('checkout') }}" current="{{ request()->routeIs('checkout') }}">Checkout</a></li>
                <li><a href="#" current="#">Payment</a></li>
                <li><a href="#" current="#">Invoice</a></li>
                <li><a href="#" current="#">Transaction</a></li>
