...
<body class="min-h-screen static bg-white dark:bg-zinc-800 font-poppins">
    <flux:header container
        ...
        <flux:navbar class="-mb-px max-lg:hidden">
            ...
            <flux:navbar.item icon="Home" :href="route('loyality.home')" :current="request()->routeIs('loyality.home')" wire:navigate>
                {{ __('Membership Program') }}
            </flux:navbar.item>
            @auth
                <flux:navbar.item icon="clock" :href="route('reservation.history')"
                    :current="request()->routeIs('reservation.history')" wire:navigate>
    ...
    <flux:sidebar stashable sticky
        ...
        <flux:navlist variant="outline">
            <flux:navlist.group :heading="__('Platform')">
                ...
                <flux:navlist.item icon="home" :href="route('loyality.home')"
                    :current="request()->routeIs('loyality.home')" wire:navigate>
                    {{ __('Dashboard') }}
                </flux:navlist.item>
                @auth
                    <flux:navlist.item icon="clock" :href="route('reservation.history')"
                        :current="request()->routeIs('reservation.history')" wire:navigate>
                        {{ __('Reservation History') }}
                    </flux:navlist.item>
                @endauth
