<flux:container class=" space-y-2 px-4 text-sm">
    ...
    <div class="">
        ...
        <div class="flex my-2 justify-between items-center">
            ...
            <div class="capitalize">{{ $transaction->payment->payment_type }}</div>
        </div>
        <flux:separator></flux:separator>
        <div class="flex justify-between items-center">
            <div class="">Total</div>
    ...
    <div class="flex justify-center">
        <flux:button variant='primary' href="{{ route('history') }}">See Your History Order</flux:button>
    </div>
